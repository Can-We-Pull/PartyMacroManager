 ...
 */
export function callMethod<T, R>(obj: T, methodName: string, ...args: unknown[]): R {
  const method = (obj as Record<string, unknown>)[methodName] as (self: T, ...args: unknown[]) => R;
 ...
 */
export function tryCallMethod<T, R>(obj: T, methodName: string, ...args: unknown[]): R | undefined {
  const method = (obj as Record<string, unknown>)[methodName] as ((self: T, ...args: unknown[]) => R) | undefined;
  if (method) {
    return method(obj, ...args);
  }
  return undefined;
